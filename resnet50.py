...
Original file is located at
    https://colab.research.google.com/drive/1I7P_MZHaQ8hZDW4ocS4y0lhbCWMbBEPU

# ResNet50 - adversarial configurations
This notebook runs AutoAttack versions of ResNet50 on two datasets: the NIH Chest X-ray classification dataset and the ISIC Skin Cancer classification dataset. This is intended to compare the adversarial performance of a standard CNN architecture to that of a standard ViT architecture, the Swin Transformer.
"""
